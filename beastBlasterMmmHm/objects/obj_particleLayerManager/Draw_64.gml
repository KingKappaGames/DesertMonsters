...
draw_text(500, 420, "prevCamY: " + string(previousCamY));
draw_text(500, 440, "sys move dir (absolute): " + string(sysCollectionMoveSign));
...
draw_text(500, 520, "camHeight: " + string(camera_get_view_height(view_camera[0])));
